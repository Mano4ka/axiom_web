  ...
  return (
    <section className="relative w-full py-20 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1500px] px-4">
        <h2 className="mb-12 text-center text-[56px] leading-[58px] text-white">
          {t('faq.title')}
        </h2>
        ...
        <div className="space-y-4">
          {faqData.map((faq, index) => {
            ...
            return (
              <div key={index} className="w-full rounded-[11px] border border-[#444444] bg-[#1C1C1C] backdrop-blur-sm overflow-hidden transition-all duration-300">
                <button
                  ...
                  <Image src="icons/arrow-left.svg" alt="arrow" width={14} height={14} className={`transform transition-transform duration-300 ease-out ${isOpen ? 'rotate-[-90deg]' : 'rotate-0'}`}/>
                </button>

                <div className="transition-all duration-300 ease-out overflow-hidden" style={{ maxHeight: isOpen ? `${contentRefs.current[index]?.scrollHeight || 200}px` : '0px',}}>
